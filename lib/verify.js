...
export default async (pluginConfig, context) => {
  ...
  const { gitlabToken, jobToken, gitlabUrl, gitlabApiUrl, proxy, ...options } = resolveConfig(pluginConfig, context);
